...
import { LayoutDashboard, Calendar, FolderKanban, Brain, FileText, Users, Building2, Github, UsersRound, Zap, Target } from "lucide-react";
import { motion } from "framer-motion";
import { cn } from "../lib/utils";

const navigation = [
  { name: "Task Board", href: "/tasks", icon: LayoutDashboard },
  ...
  { name: "Executive Council", href: "/executives", icon: UsersRound },
